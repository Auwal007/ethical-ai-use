      ...
      <div className="w-full max-w-md animate-fade-in-up">
        <div className="card-static rounded-3xl p-8 sm:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm" style={{ color: 'var(--text-secondary)' }}>Enter your credentials to access your dashboard</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="input-field !pl-11 !pr-11" required placeholder="••••••••"
                />
