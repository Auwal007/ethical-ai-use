...
import { Flame, LogOut, Menu, Moon, Shield, Sun, X } from "lucide-react";
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  ...
                  {user.streak > 0 && (
                    <p className="text-xs" style={{ color: "var(--text-muted)" }}>🔥 {user.streak} day streak</p>
                  )}
                </div>
              </div>
              ...
              <Link href="/profile" onClick={() => setMobileOpen(false)} className="block p-3 rounded font-medium text-sm" style={{ color: "var(--text-primary)" }}>
                My Profile
              </Link>
              {user.role === "admin" && (
